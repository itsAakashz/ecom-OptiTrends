            ...
            <div key={item.id} >
              <div className="flex items-center justify-between p-1 mt-8">
                  ...
                  <img
                    src={item.img}
                    alt={item.name}
                    className="h-10 lg:h-15 object-cover rounded w-[220px] h-[170]"
                  />
                  <div className="">
                    <p className="text-gray-600 ">{`Brand: ${item.brand} | Similar product from ${item.brand}`}</p>
              ...
              <div className="flex items-center justify-between p-1">
                ...
                <div className="flex">
                  <Link className="px-2 h-[40px] w-[40px]"><img src={minus_icon}/></Link>
                  <p className="px-2  text-[18px]">1</p>
                  <Link className="px-2 h-[40px] w-[40px]"><img src={plus_icon}/></Link>
                </div>
